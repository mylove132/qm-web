<template>
  <div class="echarts">
    <el-row>
      <el-col :span="8">
        <el-row>
          <div :class="className" width="100%" :style="{height: height, width: width}" ref="div1" />
        </el-row>
        <el-row>
          <div :class="className" width="100%" :style="{height: height, width: width}" ref="div3" />
        </el-row>
      </el-col>
      <el-col :span="8">
        <el-row>
          <div :class="className" width="100%" :style="{height: height, width: width}" ref="div2" />
        </el-row>
        <el-row>
          <div :class="className" width="100%" :style="{height: height, width: width}" ref="div4" />
        </el-row>
      </el-col>
      <el-col :span="8">
         <el-row>
          <div :class="className" width="100%" :style="{height: height, width: width}" ref="div5" />
        </el-row>
        <el-row>
          <div :class="className" width="100%" :style="{height: height, width: width}" ref="div6" />
        </el-row>
      </el-col>
    </el-row>
    <el-row>
      <div :class="className" width="100%" :style="{height: mapHeight, width: width}" ref="div7" />
    </el-row>
  </div>
</template>
...
export default class extends mixins(ResizeMixin) {
  ...
  @Prop({ default: "500px" }) private mapHeight!: string;
  ...
  private initChart() {
    this.chart = echarts.init(this.$refs.div1 as HTMLDivElement, "macarons");
    let data = [];
  ...
  private initChart1() {
    this.chart = echarts.init(this.$refs.div2 as HTMLDivElement, "macarons");
    let data = [];
  ...
  private initChart2() {
    this.chart = echarts.init(this.$refs.div4 as HTMLDivElement, "macarons");
    const option = {
      angleAxis: {},
      radiusAxis: {
        type: "category",
  ...
  private initChart3() {
    this.chart = echarts.init(this.$refs.div3 as HTMLDivElement, "macarons");
    const option = {
      angleAxis: {},
      radiusAxis: {
        type: "category",
   ...
   private initChart4() {
    this.chart = echarts.init(this.$refs.div5 as HTMLDivElement, "macarons");
    let data = [];
  ...
  private initChart5() {
    this.chart = echarts.init(this.$refs.div6 as HTMLDivElement, "macarons");
    const option = {
      angleAxis: {},
      radiusAxis: {
        type: "category",
  ...
  private initChart7() {
    this.chart = echarts.init(this.$refs.div7 as HTMLDivElement, "macarons");
